                ...
                <div class="h-full flex flex-auto text-white bg-no-repeat bg-cover relative bg-image">
                    <div class="w-4/5 flex flex-auto flex-col md:flex-row items-center justify-center p-10 xl:p-32 overflow-hidden">
                        ...
                        <div class="w-4/5 z-10">
                            ...
                            <div class="sm:text-sm xl:text-md text-gray-400 font-normal">落とし物をもっと見つけやすく</div>
                        </div>
                        ...
                        <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none relative z-11">
                            <div class="max-w-md w-full space-y-8">
                                <div class="text-center text-white">
                                    ...
                                    <div>
                                        <a href="{{ route('login') }}" class="w-full flex justify-center bg-yellow-300 hover:bg-gradient-to-l hover:from-purple-500 hover:to-pink-600 text-gray-100 p-4 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-500">ログイン</a>
                                    </div>
                                    <p class="flex flex-col items-center justify-center mt-10 text-center text-md">
                                        <a href="{{ route('register') }}"
                                            class="hover:text-gray-500 no-underline hover:underline cursor-pointer text-gray-400 transition ease-in duration-300">登録がまだの方はこちら</a>
                                    </p>
                                </div>
                            </div>
                        </div>
