...
<body class="antialiased">
    <div class="relative min-h-screen flex ">
        <div
            ...
            {{-- <div class="bg-yellow-50 opacity-70"> --}}
            <div class="h-full flex flex-auto text-white bg-no-repeat bg-cover relative bg-image">
                ...
                <div
                    ...
                    <x-jet-authentication-card class="bg-none absolute">
                        <x-slot name="logo">
                            <img src="https://icon-pit.com/wp-content/uploads/2019/01/user_login_icon_4394-300x300.png"
                                alt="" class="w-16 md:w-32 lg:w-48">
                        </x-slot>
